...
- **Secondary Marketplace**: P2P ticket resale with royalties
- **Dynamic Pricing**: Price discovery based on demand
- **Multi-Event Passes**: Season tickets or festival passes
- **Royalty Splits**: Automated revenue sharing for artists/venues
- **IPFS Metadata**: Decentralized storage for event images/details
- **Mobile App**: Native iOS/Android with QR scanning
- **Admin Dashboard**: Web UI for event creation and management
- **Analytics**: On-chain data visualization and reporting

### Database Integration
Backend is designed for easy database addition:
...
- Verify RPC URL: `curl http://localhost:8545`

**Frontend can't connect:**
- Check backend is running: `curl http://localhost:3001/health`
- Verify contract address in backend response
- Check MetaMask network (should be localhost:8545, Chain ID 31337)

**Transactions failing:**
- Ensure wallet has ETH (Anvil pre-funds first account)
- Check gas limits in MetaMask
- Verify contract is deployed: `cast code <CONTRACT_ADDRESS> --rpc-url http://localhost:8545`

**Port conflicts:**
- Anvil (8545), Backend (3001), Frontend (5173)
...
- **Never commit private keys** - Use environment variables or hardware wallets
- **Audit smart contracts** - Professional security audit recommended
- **Use secure RPC endpoints** - Infura, Alchemy, or self-hosted nodes
- **Implement rate limiting** - Backend API protection
- **Enable HTTPS** - Secure frontend/backend communication
- **Validate all inputs** - Both frontend and smart contract level
- **Monitor contract events** - Real-time anomaly detection

### Best Practices
- Keep Foundry and dependencies updated
- Use multi-sig wallets for contract ownership
- Implement emergency pause mechanisms
- Regular security audits and penetration testing
- Bug bounty program for production deployments
